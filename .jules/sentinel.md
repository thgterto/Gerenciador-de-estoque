...
## 2026-07-04 - [XSS in QR Code Printer]\n**Vulnerability:** XSS vulnerability in QR Code print function via `document.write`\n**Learning:** The `document.write` API can be leveraged for DOM-based XSS when printing dynamic content if variables are not escaped.\n**Prevention:** Create an inline HTML escaping function for printing content, replacing characters like <, >, and & with their corresponding HTML entities.
