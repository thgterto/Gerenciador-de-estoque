                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: GRID_TEMPLATE, alignItems: 'center', height: '100%', px: 2 }}>
                    ...
                    <Box sx={{ px: 1, textAlign: 'right', display: 'flex', justifyContent: 'flex-end', opacity: 0, transition: 'opacity 0.2s', '.MuiBox-root:hover &': { opacity: 1 } }}>
                        <Tooltip title="Clonar">
                            <IconButton aria-label="Clonar" size="small" onClick={() => onActions.clone(item)}><ContentCopyIcon fontSize="small" /></IconButton>
                        </Tooltip>
                        <Tooltip title="Editar">
                            <IconButton aria-label="Editar" size="small" onClick={() => onActions.edit(item)}><EditIcon fontSize="small" /></IconButton>
                        </Tooltip>
                        <Tooltip title="Movimentar">
                            <IconButton aria-label="Movimentar" size="small" onClick={() => onActions.move(item)}><SwapHorizIcon fontSize="small" /></IconButton>
                        </Tooltip>
                    </Box>
                </Box>
            </Box>
