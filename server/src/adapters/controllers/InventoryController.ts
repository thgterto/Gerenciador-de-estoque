...
export class InventoryController {
  ...
  async getInventory(req: FastifyRequest, res: FastifyReply) {
    ...
    // SECURITY: We let Fastify natively catch and handle async errors.
    // This allows the global error handler to sanitize error messages
    // in production, preventing internal state/stack traces from leaking.
