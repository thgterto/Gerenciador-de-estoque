...
const registerSchema = z.object({
  ...
  // 🛡️ Sentinel: Removed 'role' from schema to prevent Mass Assignment/Privilege Escalation
});
...
export class AuthController {
  ...
  async register(request: FastifyRequest, reply: FastifyReply) {
    ...
    await this.registerUserUseCase.execute({
      ...
      // 🛡️ Sentinel: Do not pass role from user input. Default to 'USER' in the entity.
    });
