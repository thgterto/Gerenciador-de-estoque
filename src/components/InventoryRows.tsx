...
interface GroupRowProps {
    ...
    style: React.CSSProperties;
    isExpanded: boolean;
    // Bolt Optimization: pass the key to the callback inside the row
    // instead of creating an inline arrow function in the parent list,
    // which prevents React.memo from breaking on every render.
