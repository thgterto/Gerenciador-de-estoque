                    ...
                    return (
                        <Tooltip key={ghs.key} content={ghs.label}>
                            <button
                                ...
                                className={`
                                    w-9 h-9 flex items-center justify-center rounded border transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orbital-danger focus-visible:ring-offset-1 focus-visible:ring-offset-orbital-bg
                                    ${isChecked
