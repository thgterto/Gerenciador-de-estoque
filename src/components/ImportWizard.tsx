                    ...
                    <div className="h-full flex flex-col items-center justify-center overflow-y-auto">
                        {isUpload ? (
                            <div className="w-full max-w-2xl h-64 flex flex-col items-center justify-center border border-dashed border-orbital-border bg-orbital-surface hover:bg-orbital-accent/5 transition-colors relative group cursor-pointer">
                                <input type="file" aria-label="Upload spreadsheet" title="Upload spreadsheet" onChange={handleFileUpload} className="absolute inset-0 opacity-0 cursor-pointer z-10" accept=".xlsx,.xls,.csv,.xlsm" />
                                ...
                                <div className="bg-orbital-surface p-6 border border-orbital-border flex flex-col gap-4 shrink-0">
                                    ...
                                    {mode === 'MASTER' && (
                                        <div className="flex flex-col gap-3">
                                             <label htmlFor="merge-strategy" className={`flex items-start gap-3 p-3 border cursor-pointer transition-all ${!replaceMode ? 'border-orbital-accent bg-orbital-accent/5' : 'border-orbital-border hover:bg-orbital-accent/5'}`}>
                                                <input type="radio" id="merge-strategy" name="import-strategy" checked={!replaceMode} onChange={() => setReplaceMode(false)} className="mt-1 text-orbital-accent bg-transparent border-orbital-border focus:ring-0" />
                                                <div>
                                            ...
                                            <label htmlFor="wipe-strategy" className={`flex items-start gap-3 p-3 border cursor-pointer transition-all ${replaceMode ? 'border-orbital-danger bg-orbital-danger/5' : 'border-orbital-border hover:bg-orbital-danger/5'}`}>
                                                <input type="radio" id="wipe-strategy" name="import-strategy" checked={replaceMode} onChange={() => setReplaceMode(true)} className="mt-1 text-orbital-danger bg-transparent border-orbital-border focus:ring-0" />
                                                <div>
