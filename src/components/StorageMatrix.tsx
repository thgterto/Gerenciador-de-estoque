                                ...
                                <div className="p-4">
                                    ...
                                    {onActions && (
                                        <div className="grid grid-cols-4 gap-2">
                                            <OrbitalButton size="sm" variant="primary" onClick={() => onActions.move(selectedItem)} icon={<Plus size={16} />} className="col-span-1" aria-label="Entrada" />
                                            <OrbitalButton size="sm" variant="danger" onClick={() => onActions.move(selectedItem)} icon={<X size={16} />} className="col-span-1" aria-label="Saída" />
                                            <OrbitalButton size="sm" variant="outline" onClick={() => onActions.move(selectedItem)} icon={<MoveLeft size={16} />} className="col-span-1" aria-label="Mover" />
                                            <OrbitalButton size="sm" variant="outline" onClick={() => onActions.edit(selectedItem)} icon={<Edit size={16} />} className="col-span-1" aria-label="Editar" />
                                        </div>
                                    )}
                                </div>
                            </div>
