...
// ⚡ Bolt: Wrapped in React.memo to prevent O(N) re-renders when parent states (like visibleCount) change.
// Expected impact: Significant reduction in render time when scrolling or filtering.
