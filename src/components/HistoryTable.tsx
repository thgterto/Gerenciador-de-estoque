...
// React.memo prevents re-rendering of visible rows when parent state (like visibleCount) changes,
// since the item object reference remains stable from the DB query.
