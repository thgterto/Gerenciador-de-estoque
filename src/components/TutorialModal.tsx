        ...
        >
            ...
            <div className="p-6">
                <div className="flex justify-between items-center mb-5">
                    ...
                    <button onClick={handleFinish} className="text-orbital-subtext hover:text-orbital-accent transition-colors" aria-label="Fechar tutorial" title="Fechar tutorial">
