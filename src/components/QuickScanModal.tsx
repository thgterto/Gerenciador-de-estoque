    ...
    <OrbitalModal isOpen={isOpen} onClose={onClose} title="SCANNER" className="max-w-md bg-black border-orbital-border" hideHeader noPadding>
        <div className="flex flex-col h-full bg-orbital-surface relative min-h-[500px]">
            ...
            <div className="absolute top-0 left-0 right-0 z-20 p-4 flex justify-between items-start bg-gradient-to-b from-black/90 to-transparent pointer-events-none">
                ...
                <button
                    onClick={onClose}
                    className="pointer-events-auto text-orbital-text hover:text-orbital-accent bg-black/50 p-2 border border-orbital-border hover:border-orbital-accent transition-all focus-visible:ring-2 focus-visible:ring-orbital-accent focus:outline-none"
            ...
            <div className="absolute top-[310px] right-4 z-20 flex flex-col gap-2 items-end">
                {continuousMode && (
                     <div className="flex bg-black/80 backdrop-blur-md border border-orbital-border p-1 animate-in slide-in-from-right-5">
                         <button
                            ...
                            className={`px-3 py-1 text-[10px] font-bold font-mono transition-colors focus-visible:ring-2 focus-visible:ring-orbital-accent focus:outline-none ${continuousType === 'ENTRADA' ? 'bg-orbital-success text-black' : 'text-orbital-subtext hover:text-white'}`}
                            aria-label="Modo de entrada contínua"
                         ...
                         <button
                            ...
                            className={`px-3 py-1 text-[10px] font-bold font-mono transition-colors focus-visible:ring-2 focus-visible:ring-orbital-accent focus:outline-none ${continuousType === 'SAIDA' ? 'bg-orbital-danger text-black' : 'text-orbital-subtext hover:text-white'}`}
                            aria-label="Modo de saída contínua"
                ...
                <button 
                    ...
                    className={`flex items-center gap-2 px-4 py-2 text-[10px] font-bold font-display uppercase tracking-wider border transition-all shadow-lg backdrop-blur-md focus-visible:ring-2 focus-visible:ring-orbital-accent focus:outline-none ${
                        continuousMode 
                        ...
                        {!continuousMode && (
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-3">
                                    <button 
                                        className="size-10 border border-orbital-border hover:border-orbital-accent hover:bg-orbital-accent/10 flex items-center justify-center text-xl font-bold text-orbital-text transition-colors focus-visible:ring-2 focus-visible:ring-orbital-accent focus:outline-none"
