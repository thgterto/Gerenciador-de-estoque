...
// Stable row component definition outside the render function
...
const VirtualizedList = ({
    ...
    const getRowHeight = (index: number) => {
        const rowItem = flatList[index];
        if (isMobile) {
            // Adjust these values based on actual mobile component heights
            return rowItem.type === 'GROUP' ? 95 : 105;
        } else {
            // Adjust these values based on actual desktop component heights
            return rowItem.type === 'GROUP' ? 56 : 56;
        }
    };
